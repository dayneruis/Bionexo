...
// Encabezado del sitio: logo, navegación principal, ícono del carrito
// y selector de idioma. CartIcon es un componente cliente que muestra
// la cantidad de ítems en tiempo real sin afectar el renderizado del servidor.

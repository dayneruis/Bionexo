...
// Fuente: lista oficial DIVIPOLA del DANE (departamentos y municipios), convertida
// a este mismo formato (codigo/nombre). Los nombres venían en mayúsculas en la
// fuente original y se pasaron a formato título (ej. "SAN JOSÉ DEL GUAVIARE" ->
// "San José del Guaviare") para que se vean igual que el resto del sitio.
...
// Los 32 departamentos de Colombia + Bogotá D.C., con la lista completa de sus municipios.
export const DEPARTAMENTOS: Departamento[] = [
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: "13670", nombre: "San Pablo de Borbur" },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: "15109", nombre: "Buena Vista" },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: "85325", nombre: "San Luis de Gaceno" },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: "86865", nombre: "Valle de Guamez" },

...
INSERT INTO "new_Product" ("available", "categoryId", "descriptionEn", "descriptionEs", "featured", "id", "imageUrl", "isInternational", "margin", "nameEn", "nameEs", "originCity", "originCountry", "originDepartment", "priceCop", "producerId", "saleZone", "size", "slug", "warranty", "warrantyDuration") SELECT "available", "categoryId", "descriptionEn", "descriptionEs", "featured", "id", "imageUrl", "isInternational", "margin", "nameEn", "nameEs", "originCity", "originCountry", "originDepartment", "priceCop", "producerId", "saleZone", "size", "slug", "warranty", "warrantyDuration" FROM "Product";
DROP TABLE "Product";

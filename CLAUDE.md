...
_Última actualización: bloque de 6 ajustes visuales (logo header, portada de marca, tirilla de valores, footer con dos logos, fix del logo en Sobre Nosotros, cartel ODS). Verificado con `npm run dev` corriendo en esta sesión._
